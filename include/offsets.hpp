...
// clang-format off
namespace offsets {
    inline constexpr const char* roblox_version = "version-5cf2272675e145f5";
    ...
    namespace Player {
        ...
        inline constexpr uintptr_t LocaleId = 0x728;
    ...
    namespace TextLabel {
        ...
        inline constexpr uintptr_t TextWrapped = 0xD3E;
